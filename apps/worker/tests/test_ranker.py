...
async def test_prefers_weight_and_recency() -> None:
    ...
    async with session_maker() as session:
        ...
        older = NewsItem(
            ...
            url="http://high/1",
            hash="hh1",
            published_at=dt.datetime(2024, 1, 1, tzinfo=tz),
        ...
        newer = NewsItem(
            ...
            url="http://low/1",
            hash="lw1",
            published_at=dt.datetime(2024, 2, 1, tzinfo=tz),
            created_at=dt.datetime(2024, 2, 1, tzinfo=tz),
        )
